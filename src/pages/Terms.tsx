...
const Terms = () => {
  const { content } = usePageContent("page_terms");
            ...
            {page?.sections?.length ? (
              ...
              <>
                <section className="p-6 rounded-lg border border-border bg-card/50">
                  ...
                  <p className="text-muted-foreground leading-relaxed">By accessing or using CyberOps, you agree to be bound by these Terms of Service.</p>
                </section>
                <section className="p-6 rounded-lg border border-border bg-card/50">
                  <h2 className="font-display text-xl font-bold text-foreground mb-4">2. User Accounts</h2>
                  <p className="text-muted-foreground leading-relaxed">You are responsible for maintaining the security of your account and password.</p>
                </section>
              </>
            )}
          </div>
